...
describe("prisma migration pipeline + field-complete models (phase-01 §6/§14)", () => {
  ...
  it("creates every phase-01 table, including the Auth.js adapter tables, plus phase-02's Repository, phase-03's indexing tables, phase-04's knowledge-graph tables, phase-05's vector-search tables, phase-06's webhook-ingestion tables, and phase-07's review-pipeline tables", async () => {
