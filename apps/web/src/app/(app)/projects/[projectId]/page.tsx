...
export default async function ProjectDetailPage({
  ...
  const [detail, installationsResult] = await Promise.all([
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-10">
      ...
      <div className="mt-8">
        <InstallationsPanel
          installations={
            installationsResult.ok ? installationsResult.installations : []
          }
          installUrl={
            installationsResult.ok ? installationsResult.installUrl : ""
          }
