...
_A plain-language description of the access this application requests, written for
review by anyone evaluating whether to install it._
...
_Scope of this document._ This is the permission rationale `plan.md` §17 asks to have in
